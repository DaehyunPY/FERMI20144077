...
solved = {
    'beta1_amp':
        (2 * coeff_p * sqrt(60 * coeff_d ** 2
                            + 60 * sqrt(5) * coeff_d * coeff_s * cos(eta_d - eta_s)
                            + 75 * coeff_s ** 2)
         / (5 * (coeff_d ** 2 + coeff_p ** 2 + coeff_s ** 2))),
    'beta1_shift':
    ...
    'beta1m3_amp':
        (2 * sqrt(3) * coeff_p * coeff_s
         / (coeff_d ** 2 + coeff_p ** 2 + coeff_s ** 2)),
    'beta1m3_shift': arg(-I * sin(eta_p - eta_s) + cos(eta_p - eta_s)),
    'beta2':
        ((10 * coeff_d ** 2 + 14 * sqrt(5) * coeff_d * coeff_s * cos(eta_d - eta_s) + 14 * coeff_p ** 2)
         / (7 * (coeff_d ** 2 + coeff_p ** 2 + coeff_s ** 2))),
    'beta3_amp':
        (6 * sqrt(15) * coeff_d * coeff_p
         / (5 * (coeff_d ** 2 + coeff_p ** 2 + coeff_s ** 2))),
